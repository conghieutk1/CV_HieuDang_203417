...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->txtTVT->TextChanged += gcnew System::EventHandler(this, &mainForm::txtTVT_TextChanged);
			// 
			// txtTG
			// 
...
private: System::Void txtTVT_TextChanged(System::Object^ sender, System::EventArgs^ e) {
	if (txtTVT->Text->Length > 20) {
		MessageBox::Show("The number of characters must be less than 20");
		txtTVT->Clear();
		return;
...
private: System::Void txtTG_TextChanged(System::Object^ sender, System::EventArgs^ e) {
	if (txtTG->Text->Length > 50) {
		MessageBox::Show("The number of characters must be less than 50");
		txtTG->Clear();
		return;
